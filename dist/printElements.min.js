!(function (t, r) {
  ...
  function r() {
    ...
    var L = Object.getPrototypeOf,
      E = L && L(L(G([])));
    E && E !== n && o.call(E, c) && (b = E);
    var _ = (x.prototype = m.prototype = Object.create(b));
    function O(t) {
    ...
    function P(r, e, n) {
      ...
      return function (i, a) {
        ...
        for (n.method = i, n.arg = a; ; ) {
          ...
          "throw" === f.type &&
            ((o = d), (n.method = "throw"), (n.arg = f.arg));
        }
      };
    }
    function k(r, e) {
      ...
      if (r || "" === r) {
        ...
        if (!isNaN(r.length)) {
          var n = -1,
            i = function e() {
              for (; ++n < r.length; )
                if (o.call(r, n)) return (e.value = r[n]), (e.done = !1), e;
      ...
      (T.prototype = {
        ...
        finish: function (t) {
          for (var r = this.tryEntries.length - 1; r >= 0; --r) {
            ...
            if (e.finallyLoc === t)
              return this.complete(e.completion, e.afterLoc), S(e), g;
          }
        },
        catch: function (t) {
          for (var r = this.tryEntries.length - 1; r >= 0; --r) {
        ...
        return r().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                return (
                  (o = document.createElement("div")).classList.add("outprint"),
              ...
              case 7:
                t.sent.forEach(function (t) {
                  Array.from(t.querySelector(s).querySelectorAll(a.toString()))
                    .filter(function (t) {
  ...
  (t.printElements = o), Object.defineProperty(t, "__esModule", { value: !0 });
});
